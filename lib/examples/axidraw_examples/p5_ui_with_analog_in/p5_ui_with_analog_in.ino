...
void setup() {
  ...
  in_amplitude.set_floor(0, 25);
  in_amplitude.set_ceiling(10, 1020); //radians per second
  in_amplitude.map(&wave2d_gen.amplitude);
  in_amplitude.begin(IO_A1);
