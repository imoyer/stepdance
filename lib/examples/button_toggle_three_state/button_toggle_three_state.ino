...
// -- 1D Wave Generator for Pen up down oscillation--
...
void setup() {
  ...
  button_d1.set_callback_on_release(&pen_up);
    ...
    // -- Configure 3 state toggle button --
  button_d2.begin(IO_D2, INPUT_PULLDOWN);
  button_d2.set_mode(BUTTON_MODE_TOGGLE_THREE_STATE);
  button_d2.set_callback_on_first_press(&generator_state_1);
  button_d2.set_callback_on_second_press(&generator_state_2);
  button_d2.set_callback_on_third_press(&generator_state_3);
 ...
 // -- Configure Wave Generator --
  ...
  wave_gen.output.map(&channel_z.input_target_position);
...
void generator_state_1(){
wave_gen.frequency = 1.0; 
}

void generator_state_2(){
  wave_gen.frequency = 10.0; 
}

void generator_state_3(){
